...
export default function CategoriesPage() {
    ...
    const handleOpen = (category?: Category) => {
        setCurrentCategory(category || { name: '', description: '', isFeatured: false, heroImage: '', squareImage: '', mainCategory: 'food' });
        setOpen(true);
    };
                ...
                <form onSubmit={handleSubmit}>
                    <DialogContent sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                        ...
                        <TextField
                            ...
                            label="Main Category"
                            name="mainCategory"
                            value={currentCategory.mainCategory || 'food'}
                            onChange={(e) => setCurrentCategory({ ...currentCategory, mainCategory: e.target.value as 'food' | 'drinks' })}
                            fullWidth
                        >
