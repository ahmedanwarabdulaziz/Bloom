...
export default async function Welcome() {
    ...
    return (
        <main className="w-full h-[100dvh] min-h-[100dvh] relative flex flex-col bg-background overflow-hidden items-center">
            ...
            <div className="absolute inset-0 z-0 bg-black pointer-events-none overflow-hidden">
                ...
                {/* 2. Content Layer */}
                <div className="relative z-10 flex flex-col px-5 pt-4 pb-0 flex-1 min-h-0 w-full max-w-6xl mx-auto">
                ...
                <div className="w-full z-20 px-6 pb-6 pt-2 shrink-0 max-w-md mx-auto mt-2 md:mt-4">
                    <Link href="/menu" className="block group w-full">
                        <button className="w-full relative bg-gradient-to-b from-yellow-400 to-accent-main text-background font-extrabold py-3.5 rounded-full text-base sm:text-lg shadow-[0_8px_20px_rgba(212,175,55,0.35),inset_0_-4px_0_rgba(180,146,42,0.4),inset_0_2px_0_rgba(255,255,255,0.6)] flex items-center justify-center transition-all transform active:translate-y-1 active:shadow-[0_2px_10px_rgba(212,175,55,0.3),inset_0_-1px_0_rgba(180,146,42,0.4),inset_0_1px_0_rgba(255,255,255,0.6)] duration-150">
                            <span className="drop-shadow-sm tracking-wide">View Full Menu</span>
                            <div className="absolute right-2 bg-background/95 text-accent-main h-9 w-9 rounded-full flex items-center justify-center shadow-[inset_0_2px_4px_rgba(0,0,0,0.1)]">
