            ...
            <main className="w-full h-[100dvh] min-h-[100dvh] relative flex flex-col bg-background overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col px-5 pt-4 pb-0 flex-1 min-h-0">
                    ...
                    <div className="flex-1 flex flex-col items-center w-full pt-2 pb-2 min-h-0">
                        ...
                        <div className="text-center px-2 w-full shrink-0">
                            <h1 className="text-[13px] min-[375px]:text-[15px] min-[400px]:text-[16px] sm:text-xl md:text-2xl font-extrabold text-main-text leading-[1.1] tracking-tighter drop-shadow-md whitespace-nowrap">
                                FLAME-GRILLED <span className="font-light text-accent-main">SHISHA-CHILLED</span>
                            </h1>
                            <p className="text-muted-text text-[11px] sm:text-sm mt-1.5 font-medium max-w-[320px] mx-auto opacity-90 hidden min-[375px]:block leading-relaxed">
                ...
                <div className="w-full z-20 px-6 pb-6 pt-2 shrink-0">
                    <Link href="/menu" className="block group w-full">
                        <button className="w-full relative bg-gradient-to-b from-teal-400 to-accent-main text-background font-extrabold py-3.5 rounded-full text-base sm:text-lg shadow-[0_8px_20px_rgba(45,212,191,0.35),inset_0_-4px_0_rgba(20,184,166,0.4),inset_0_2px_0_rgba(255,255,255,0.6)] flex items-center justify-center transition-all transform active:translate-y-1 active:shadow-[0_2px_10px_rgba(45,212,191,0.3),inset_0_-1px_0_rgba(20,184,166,0.4),inset_0_1px_0_rgba(255,255,255,0.6)] duration-150">
                            <span className="drop-shadow-sm tracking-wide">View Full Menu</span>
                            <div className="absolute right-2 bg-background/95 text-teal-500 h-9 w-9 rounded-full flex items-center justify-center shadow-[inset_0_2px_4px_rgba(0,0,0,0.1)]">
